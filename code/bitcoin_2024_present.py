...
# Read data files
df_btc_price = pd.read_csv('BTC Data 2024/Bitcoin Historical Data 2024.csv')
df_btc_trends = pd.read_csv('BTC Data 2024/multiTimeline 2024.csv',
                            skiprows=2)
...
plt.title("Bitcoin Price and Search Trend (2024-Present)", fontsize=18)
